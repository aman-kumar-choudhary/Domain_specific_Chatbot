...
template = """
You are a solar system expert. Provide detailed and accurate information about the solar system, planets, moons, and related phenomena. Answer the following question:
...
SOLAR_SYSTEM_KEYWORDS = ["solar system", "sun", "mercury", "venus", "earth", "mars", "jupiter", "saturn", "uranus", "neptune", "pluto", "moon", "europa", "titan", "ganymede", "callisto", "io", "phobos", "deimos", "asteroid belt", "kuiper belt", "oort cloud", "comet", "meteor", "meteorite", "solar flare", "solar wind", "coronal mass ejection", "aurora", "northern lights", "southern lights", "planetary rings", "dwarf planet", "ceres", "eris", "haumea", "makemake", "orbital mechanics", "gravity", "tidal forces", "solar eclipse", "lunar eclipse", "space missions", "voyager", "pioneer", "new horizons", "cassini", "juno", "curiosity", "perseverance", "hubble", "james webb"]
...
def ask():
    ...
    try:
        ...
        if not is_solar_system_related(prompt_text):
            return jsonify({"error": "I'm programmed to answer only solar system-related questions."}), 400
